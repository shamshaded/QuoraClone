...
const WidgetOptions = () => {
  return (
    <div className="widget_options">
      ...
      <div className="widget_content">
        <img
          src="https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=772&q=80"
          alt=""
        />
        <div className="widget_contentTitle">
          <h5>Art & Artist</h5>
      ...
      <div className="widget_content">
        <img
          src="https://images.unsplash.com/photo-1596558450268-9c27524ba856?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=725&q=80"
          alt=""
        />
        <div className="widget_contentTitle">
      ...
      <div className="widget_content">
        <img
          src="https://images.unsplash.com/photo-1554498808-d3ae8f23540c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
          alt=""
        />
        <div className="widget_contentTitle">
      ...
      <div className="widget_content">
        <img
          src="https://hips.hearstapps.com/hmg-prod/images/gettyimages-515350818jpg-.jpg?resize=1200:*"
          alt=""
        />
        <div className="widget_contentTitle">
